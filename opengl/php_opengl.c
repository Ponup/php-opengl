...
const zend_function_entry opengl_functions[] = {
	...
	PHP_FE(glgetbooleanv,NULL)
	PHP_FE(glgetclipplane,NULL)
	PHP_FE(glgetdoublev,NULL)
	PHP_FE(glgeterror,NULL)
	PHP_FE(glgetfloatv,NULL)
	PHP_FE(glgetintegerv,NULL)
	PHP_FE(glgetlightfv,NULL)
	PHP_FE(glgetlightiv,NULL)
	PHP_FE(glgetmapdv,NULL)
	PHP_FE(glgetmapfv,NULL)
	PHP_FE(glgetmapiv,NULL)
	PHP_FE(glgetmaterialfv,NULL)
	PHP_FE(glgetmaterialiv,NULL)
	PHP_FE(glgetpixelmapfv,NULL)
	PHP_FE(glgetpixelmapuiv,NULL)
	PHP_FE(glgetpixelmapusv,NULL)
	PHP_FE(glgetpointerv,NULL)
	PHP_FE(glgetpolygonstipple,NULL)
	PHP_FE(glgetstring,NULL)
	PHP_FE(glgettexenvfv,NULL)
	PHP_FE(glgettexenviv,NULL)
	PHP_FE(glgettexgendv,NULL)
	PHP_FE(glgettexgenfv,NULL)
	PHP_FE(glgettexgeniv,NULL)
	PHP_FE(glgetteximage,NULL)
	PHP_FE(glgettexlevelparameterfv,NULL)
	PHP_FE(glgettexlevelparameteriv,NULL)
	PHP_FE(glgettexparameterfv,NULL)
	PHP_FE(glgettexparameteriv,NULL)
	PHP_FE(glhint,NULL)
	...
	PHP_FE(glupickatrix,NULL)
	PHP_FE(gluproject,NULL)
	PHP_FE(glunuproject,NULL)
	PHP_FE(gluscaleimage,NULL)
	...
	PHP_FE(glugetnurbsproperty,NULL)
...
PHP_FUNCTION(glselectbuffer)
{
	zval *size, *buffer;
	GLuint *v_buffer;
	TWO_PARAM(size, buffer);
	convert_to_long(size);
	convert_to_array(buffer);
	v_buffer = php_array_to_uint_array(buffer);
	glSelectBuffer((int)Z_LVAL_P(size),v_buffer);
}
/* }}} */
