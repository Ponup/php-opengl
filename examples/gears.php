    ...
    for ($w = $wd / 2; $w > -$wd; $w -= $wd) {
        ...
        if ($ir == 0.0) {
            ...
            for ($i = 1; $i < $circle_subdiv; $i++) {
                glVertex3f(cos(2.0 * M_PI * $i / $circle_subdiv) * $or, sin(2.0 * M_PI * $i / vcircle_subdiv) * $or, $w);
            }
            glVertex3f($or, 0.0, $w);
            glEnd();
        } else {
            ...
            glVertex3f($ir, 0.0, $w);
            for ($i = 1; $i < $circle_subdiv; $i++) {
                glVertex3f(cos(2.0 * M_PI * $i / $circle_subdiv) * $or, sin(2.0 * M_PI * $i / $circle_subdiv) * $or, $w);
                glVertex3f(cos(2.0 * M_PI * $i / $circle_subdiv) * $ir, sin(2.0 * M_PI * $i / $circle_subdiv) * $ir, $w);
            }
            glVertex3f($or, 0.0, $w);
            glVertex3f($ir, 0.0, $w);
            glEnd();
