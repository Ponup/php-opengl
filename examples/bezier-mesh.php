...
class Renderer
{
	...
	public function initLights()
	{
		...
		$diffuseMaterial = array( 0.6, 0.6, 0.6, 1.0 );
		$specularMaterial = array( 1.0, 1.0, 1.0, 1.0 );
		$shinimessMaterial = array( 50.0 );
	...
	public function keyboard( $key, $x, $y ) { exit( 0 ); }
}
...
glutReshapeFunc( array( $renderer, 'reshape' ) );
glutDisplayFunc( array( $renderer, 'display' ) );
glutKeyboardFunc( array( $renderer, 'keyboard' ) );
glutMainLoop();
